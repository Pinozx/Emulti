...
<div class="row">
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
        <form role="form" action="mtpform.php" method="POST" name="formmtp" id="formmtp">
...
<!-- FIN CODIGO MENSAJE-->
    ...
    <div class="contenido">
        ...
        <table class="table">
         <tbody>
          <?php
           $consulta = "SELECT * from testintervencionpsicologica";
           $resultado = mysqli_query($conexion,$consulta);
           while($lista = mysqli_fetch_array($resultado)){
          ?>
      <form name="fmr_tst" action="mtpform.php" method="post">
         <tr style="background-color:white">
         <input name="idintervencion" type="hidden" value="<?php echo $lista['idintervencion'];?>">
         <input name="runpaciente" type="hidden" value="<?php echo $lista['runpaciente']?>">
                <th><?php echo $lista['runpaciente'];?></th>
                <th><?php echo $lista['fechaevaluacion'];?></th>
