...
<!-- Inicio Contenido Buscar -->
               <div class="row">
                  ...
                  <?php
                                ...
                                $result = mysqli_query($link, "SELECT runpaciente, fechaevaluacion, objetivo, actividad FROM testintervencionpsicologica");
                                if ($row = mysqli_fetch_array($result, MYSQLI_NUM)){
                                    echo "<thead><tr><th>Run</th><th>Fecha Reevaluacion</th><th>Objetivo</th><th>Actividad</th></tr></thead> \n";
                                    do {
